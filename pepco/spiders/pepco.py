...
class PepcoSpider(Spider):
    ...
    def __init__(self, download_directory=None, *args, **kwargs):
        ...
        with open('EquityMgmt2LLC-account_number.csv', 'rb') as csvfile_numbers:
            reader_numbers = csv.reader(csvfile_numbers)
            self.number_list = []
            for row_index, row in enumerate(reader_numbers):
                if row_index != 0:
                    self.number_list.append(row[0])
    ...
    def parse(self, response):
        ...
        while all_users_option:
            ...
            while all_numbers_option:
                ...
                account_number = self.number_list[account_index]
                # account_number = '50013041129'

                if account_number not in self.logs:
                ...
                if account_index > len(self.number_list) - 1:
    ...
    def download_page(self, print_btn=None, account_number=None, bill_date=None):
        ...
        self.write_logs(account_number)
